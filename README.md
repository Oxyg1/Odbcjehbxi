...
отбрасываются автоматически. Если с первого набора кандидатов свободных находится
меньше, чем запрошено, бот доп. генерирует и проверяет ещё, пока не наберёт нужное
количество или не упрётся в лимит попыток (актуально для коротких длин вроде 5
